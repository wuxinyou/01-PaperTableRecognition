...
void CMFCApplication1Dlg::OnBnClickedButton1()
{
	...
	CString strResoult;
	strResoult = text_out.string();
	//UTF8ToGBK(strResoult);
	MessageBox(strResoult);
}


void CMFCApplication1Dlg::UTF8ToGBK(CString& strUtf8)
{
	int len = MultiByteToWideChar(CP_UTF8, 0, (LPCCH)(LPCTSTR)strUtf8, -1, NULL, 0);
	unsigned short * wszGBK = new unsigned short[len + 1];
	memset(wszGBK, 0, len * 2 + 2);
	MultiByteToWideChar(CP_UTF8, 0, (LPCCH)(LPCTSTR)strUtf8, -1, (LPWSTR)wszGBK, len);
